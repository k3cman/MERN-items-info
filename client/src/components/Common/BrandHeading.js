...
function BrandHeading(props) {
  if (props.title === "Marazzi") {
    return <img src={MarazziLogo} height="30" alt="brand logo" />;
  }
  if (props.title === "KAI") {
    return <img src={KAILogo} height="30" alt="brand logo" />;
  }
  if (props.title === "HansGrohe") {
    return <img src={HGLogo} height="30" alt="brand logo" />;
  }
  if (props.title === "Argenta") {
    return <img src={ArgentaLogo} height="30" alt="brand logo" />;
  }
  if (props.title === "DURA") {
    return <img src={DuraLogo} height="30" alt="brand logo" />;
  }
  if (props.title === "Akgun") {
    return <img src={AkgunLogo} height="30" alt="brand logo" />;
  }
  if (props.title === "GAOGE") {
    return <img src={GaogeLogo} height="30" alt="brand logo" />;
  }
  if (props.title === "Baldocer") {
    return <img src={BaldocerLogo} height="30" alt="brand logo" />;
  }
  if (props.title === "Hispania") {
    return <img src={Hispania} height="30" alt="brand logo" />;
  }
  if (props.title === "QUA") {
    return <img src={QUA} height="30" alt="brand logo" />;
  }
  if (props.title === "Roca") {
    return <img src={Roca} height="30" alt="brand logo" />;
  }
  if (props.title === "Prismacer") {
    return <img src={Prismacer} height="30" alt="brand logo" />;
  }
  if (props.title === "Serra") {
    return <img src={Serra} height="30" alt="brand logo" />;
  }
  if (props.title === "ITA") {
    return <img src={ITA} height="30" alt="brand logo" />;
  }
  if (props.title === "BOBO") {
    return <img src={BOBO} height="30" alt="brand logo" />;
  }
  if (props.title === "Usak") {
    return <img src={Usak} height="30" alt="brand logo" />;
  }
  if (props.title === "Marco Polo") {
    return <img src={MarcoPolo} height="30" alt="brand logo" />;
  }
  if (props.title === "Sintesi") {
    return <img src={Sintesi} height="30" alt="brand logo" />;
  }
  if (props.title === "Bien") {
    return <img src={Bien} height="30" alt="brand logo" />;
  }
  if (props.title === "Vidima") {
    return <img src={Vidima} height="30" alt="brand logo" />;
  }
  if (props.title === "Ideal") {
    return <img src={Ideal} height="30" alt="brand logo" />;
  }
  if (props.title === "Rovese") {
    return <img src={Rovese} height="30" alt="brand logo" />;
  }
  if (props.title === "Ece") {
    return <img src={Ece} height="30" alt="brand logo" />;
  }
  if (props.title === "VB") {
    return <img src={VB} height="30" alt="brand logo" />;
  }
  if (props.title === "IS baterije") {
    return <img src={Ideal} height="30" alt="brand logo" />;
  }
  if (props.title === "Grohe") {
    return <img src={Grohe} height="30" alt="brand logo" />;
  }
  if (props.title === "Huppe") {
    return <img src={Huppe} height="30" alt="brand logo" />;
  }
  if (props.title === "Zorka") {
    return <img src={Zorka} height="30" alt="brand logo" />;
  }
